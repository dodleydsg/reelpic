...
export default function SearchInput({ name, placeholder, queryCallback }) {
  ...
  return (
    <>
      ...
      />
      <div className="absolute delay-150 transition scale-y-0 origin-top ease-in-out duration-150 rounded mt-2 bg-white w-full lg:w-1/2 z-20 border border-gray-100  divide-y-2 divide-gray-100">
